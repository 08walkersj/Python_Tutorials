...
def answer(question):
    if question.lower()=='q1':
        ...
        answer="The string 'butt' is the 4th item in the list so it can be accessed with the number 3\n"\
            "print(List[3]) this will print 'butt'"\
            "To make things easier we will make a variable called word:\n"\
            "word= List[3]\n"\
            "print(word) will now print 'butt'\n"\
            "So lets get the letter u from 'butt'\n"\
            ...
            "So to print 'butt' we will use print(List[-1])\n"\
            "And to print the 'u' from 'butt' we can use print(List[-1][-3]) or print(List[-1][1])\n"\
